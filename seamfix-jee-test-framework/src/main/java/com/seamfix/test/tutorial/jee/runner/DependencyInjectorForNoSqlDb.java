...
public class DependencyInjectorForNoSqlDb {

    private static final DependencyInjectorForNoSqlDb INSTANCE = new DependencyInjectorForNoSqlDb();

    public static DependencyInjectorForNoSqlDb getInstance() {
        return INSTANCE;
    }

    private List<Injector> injectors = new LinkedList<>();

    private DependencyInjectorForNoSqlDb() {
